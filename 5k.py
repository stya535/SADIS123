...
#cl = LineClient()
cl = LineClient(authToken='EAQJpKIDEQ68jeWgNZv0.9q2iIcfJltjghJCvoSD1Wa.ywhP4harBFBCP3f7U6LESg+esnNupMLKAp+aC7nQk7c=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

#ki = LineClient()
ki = LineClient(authToken='EAI8Ca01EIXVqazeQ2Sd.AmGDRgFE5yBdIVKXJYYlpq.wtSigWTX0Ko59VtEOlFth/2zD6dviXqjV6juWc79uzo=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

#kk = LineClient()
kk = LineClient(authToken='EAnQgPJdxAmOyROTVqWb.uX0SsiemH0c3zs3E2pMkMW.0gWMPlnfwcMeYOxnQsKDapo73ejD0Qox6/nMM/Zft0k=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

#kc = LineClient()
kc = LineClient(authToken='EAUPEs6802OtbYAfPry2.LdHhDSGdYYWJ+Ax6bPisWG.Sbh3kvQdaknN1I6/YzoM79DvBA7zcZe/IMI/BhminzA=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

#kb = LineClient()
kb = LineClient(authToken='EAsvo1i4BZJop4RNVvj1.lPUNU+brdzI8JxFWeMWmOq.+NAdiJ/dKBdajzy9XFgUBrE662uV1lUuRkA0FmWnACg=')
kb.log("Auth Token : " + str(kb.authToken))
channel4 = LineChannel(kb)
kb.log("Channel Access Token : " + str(channel4.channelAccessToken))

#kd = LineClient()
kd = LineClient(authToken='EAlfknYJGZ2EpNTN4Ve9.EOYcW0xngUInI+VLRYA+sq.PiJkmO1f3WjM5lUmDhHhcmnhIyHfGVSB9Dm/jhexNG8=')
kd.log("Auth Token : " + str(kd.authToken))
channel5 = LineChannel(kd)
kd.log("Channel Access Token : " + str(channel5.channelAccessToken))

#sw = LineClient()
sw = LineClient(authToken='EAP5NKkPObWwOIdyn0Ee.whINWvoyr4rxc5slrzAe+G.JaUt9qCzg1dqeQKQqK0+aq7pBQu3IPg9912oiBEL+/I=')
